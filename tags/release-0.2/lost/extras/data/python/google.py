...
def locationCoord(lat, lon, zoom):
    ...
    return (col, row, zoom, pow(2, zoom));
	
	
# Main
if __name__ == '__main__':
    col, row, zoom, tiles = locationCoord( 65.681264, 24.755917, 5)
    ...
    print "Y coordinate within the tile =", (row - long(row)) * TILE_SIZE
    print "Tiles in current zoom level =", tiles
