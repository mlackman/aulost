...
_CPP = {80000:20,40000:10,16000:4,8000:2,4000:1}
...
class MapPiece(object):
    ...
    def __init__(self, rect, screenLocation,zoomLevel):
        ...
        self.url = 'http://kansalaisen.karttapaikka.fi/image?request=GetMap&bbox=%d,%d,%d,%d&scale=%d&width=600&height=600&srs=NLSFI:kkj&styles=normal&lang=FI&lmid=1179938105236' % (bottomY, bottomX, topY, topX, zoomLevel)
        self.image = None
...
if __name__ == '__main__':
    k = Karttapaikka()
    mp = k.getMap((65.681264, 24.755917), (400,400)) 
    k.zoomIn()
    for m in mp.mapPieces:
        print m.url
